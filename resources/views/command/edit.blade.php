        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">{{ __('Fill and submit this form to edit the command.') }}</p>
                        <hr>
                        ...
                        <form action="{{ route('command.update', $command->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="command-name" name="name" value="{{ old('name', $command->name) }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    id="command-description" name="description" rows="4"
